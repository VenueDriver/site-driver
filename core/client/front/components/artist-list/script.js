...
var ArtistListComponent = (function () {
    function ArtistListComponent(PdService) {
        this.PdService = PdService;
        this.ready = false;
        this.activeItems = false;
        this.listChange = new core_1.EventEmitter();
    }
    ArtistListComponent.prototype.toggleItem = function (item) {
        item.checked = !item.checked;
        this.listChange.emit(this.artists.filter(function (el) { return el.checked; }));
    };
    ArtistListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.PdService.artists().then(function (artists) {
            _this.artists = artists.map(function (el) {
    ...
    ], ArtistListComponent.prototype, "activeItems", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], ArtistListComponent.prototype, "listChange", void 0);
