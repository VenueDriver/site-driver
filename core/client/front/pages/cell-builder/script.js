...
var CellBuilder = (function () {
    function CellBuilder(moleculeService) {
        this.moleculeService = moleculeService;
        this.ready = true;
    }
    CellBuilder.prototype.log = function (what) {
        console.log(what);
    };
    CellBuilder.prototype.ngOnInit = function () {
        var _this = this;
...
exports.CellBuilder = CellBuilder;
